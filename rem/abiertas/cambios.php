 ...
 */
define("PAGE_TITLE", "Edición de Remisión");
                         ...
                         <div class="card-body">
                            <div class="form-body">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                  <input type="text" id="folio" class="form-control border-primary" name="folio">
                                </div>
                                <label class="col-sm-2 offset-4 label-control" for="fecha">Fecha*</label>
                                <div class="col-sm-2">
