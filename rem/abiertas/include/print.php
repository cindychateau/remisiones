<?php
    ...
    if(isset($_GET['id'])) {
		...
		if(!isset($_GET['fondo']) || $_GET['fondo'] == 1) {
		...
		if($remision['empresa'] == 'Sky Consulting Partners') {
			...
			//Subtotal
			if($remision['subtotal'] > 0) {
				$pdf->SetXY(169, 266);
				$remision['subtotal'] = number_format($remision['subtotal'], 2);
				$pdf->Cell(33,6,$remision['subtotal'],0,0,'R');
			}

			//IVA
			if($remision['iva'] > 0) {
				$pdf->SetXY(169, 273);
				$remision['iva'] = number_format($remision['iva'], 2);
				$pdf->Cell(33,6,$remision['iva'],0,0,'R');
			}

			//Total
			if($remision['total'] > 0) {
				$pdf->SetXY(169, 280);
				$remision['total'] = number_format($remision['total'], 2);
				$pdf->Cell(33,6,$remision['total'],0,0,'R');
			}
			...
			if($remision['subtotal'] > 0) {
				$pdf->SetXY(177, 263);
				$remision['subtotal'] = number_format($remision['subtotal'], 2);
				$pdf->Cell(25,6,$remision['subtotal'],0,0,'R');
			}
			...
			if($remision['iva'] > 0) {
				$pdf->SetXY(177, 270);
				$remision['iva'] = number_format($remision['iva'], 2);
				$pdf->Cell(25,6,$remision['iva'],0,0,'R');
			}
			...
			if($remision['total'] > 0) {
				$pdf->SetXY(177, 276);
				$remision['total'] = number_format($remision['total'], 2);
				$pdf->Cell(25,6,$remision['total'],0,0,'R');
			}
			...
			if($remision['subtotal'] > 0) {
				$pdf->SetXY(157, 264);
				$remision['subtotal'] = number_format($remision['subtotal'], 2);
				$pdf->Cell(39,7,$remision['subtotal'],0,0,'R');
			}
			...
			if($remision['iva'] > 0) {
				$pdf->SetXY(157, 272);
				$remision['iva'] = number_format($remision['iva'], 2);
				$pdf->Cell(39,7,$remision['iva'],0,0,'R');
			}
			...
			if($remision['total'] > 0) {
				$pdf->SetXY(157, 279);
				$remision['total'] = number_format($remision['total'], 2);
				$pdf->Cell(39,7,$remision['total'],0,0,'R');
			}
