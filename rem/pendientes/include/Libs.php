		...
		try {
			...
			*/
			...
			foreach ($puntero as $row) {
				...
				$aRow = array($row['folio'],$row["SIU_NOMBRE"], $row['shortname'], $row['nombre'], $row['empresa'],$row['servicio'], $row['ocs'], $row['fecha'], $row['direccion'], $tabla_info, $btn_solicitar_cerrar);
