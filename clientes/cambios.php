 ...
 */
define("PAGE_TITLE", "Edición de Cliente");
              ...
              <input name="id" type="hidden" id="id" value="<?php echo isset($_GET['id']) ? $_GET['id'] : '-1' ; ?>">
               <div class="row">
                  <div class="col-md-12">
                           ...
                           <div class="card-body">
                              <div class="form-body">
                                 <div class="form-group row">
                                    <label class="col-sm-2 label-control" for="empresa">Nombre de Empresa*</label>
                                    <div class="col-sm-10">
                                       <input type="text" id="empresa" class="form-control border-primary" name="empresa">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-sm-2 label-control" for="shortname">Shortname*</label>
                                    <div class="col-sm-4">
                                       <input type="text" id="shortname" class="form-control border-primary" name="shortname">
                                    </div>
                                    <label class="col-sm-2 label-control" for="rfc">RFC*</label>
                                    <div class="col-sm-4">
                                       <input type="text" id="rfc" class="form-control border-primary" name="rfc">
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="card">
                      <div class="card-header">
                        <h4 class="card-title" id="horz-layout-colored-controls"><i class="ft-user"></i> CONTACTO</h4>
                        <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                        ...
                        <div class="card-body">
                          <div class="form-body">
                            <div id="cont-contacto">
                              <div id="contacto_0">
                                <div class="row">
                                  <div class="col-sm-12">
                                    <div class="form-group row">
                                      <label class="col-sm-2 label-control" for="contacto_nombre_0">Nombre Completo*</label>
                                      <div class="col-sm-10">
                                        <input type="text" id="contacto_nombre_0" class="form-control border-primary" name="contacto_nombre[0]">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group row">
                                      <label class="col-sm-2 label-control" for="contacto_area_0">Área</label>
                                      <div class="col-sm-4">
                                        <input type="text" id="contacto_area_0" class="form-control border-primary" name="contacto_area[0]">
                                      </div>
                                      <label class="col-sm-2 label-control" for="contacto_puesto_0">Puesto</label>
                                      <div class="col-sm-4">
                                        <input type="text" id="contacto_puesto_0" class="form-control border-primary" name="contacto_puesto[0]">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group row">
                                      <label class="col-sm-2 label-control" for="contacto_email_0">E-mail*</label>
                                      <div class="col-sm-4">
                                        <input type="text" id="contacto_email_0" class="form-control border-primary" name="contacto_email[0]">
                                      </div>
                                      <label class="col-sm-2 label-control" for="contacto_telefono_0">Teléfono*</label>
                                      <div class="col-sm-4">
                                        <input type="text" id="contacto_telefono_0" class="form-control border-primary" name="contacto_telefono[0]">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group row">
                                      <label class="col-sm-2 label-control" for="contacto_celular_0">Celular</label>
                                      <div class="col-sm-4">
                                        <input type="text" id="contacto_celular_0" class="form-control border-primary" name="contacto_celular[0]">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div class="form-group overflow-hidden">
                                <div class="col-12">
                                    <button data-repeater-create class="btn btn-primary agregar-contacto">
                                        <i class="ft-plus"></i> Agregar Contacto
                                    </button>
                                </div>
                            </div>
                          </div>
